...
export const CATEGORY_COLORS: Record<string, string> = {
  ...
  procurement: "bg-cyan-100 text-info dark:bg-cyan-950 dark:text-info",
  other: "bg-muted text-muted-foreground dark:bg-[var(--navy-mid)] dark:text-muted-foreground/80",
};
