    ...
    },
    {
      ...
      render: (_, vr) =>
        vr.isOverBudget ? (
          ...
          <span className="inline-flex items-center rounded bg-slate-100 px-1.5 py-0.5 text-[9px] font-medium text-slate-600 dark:bg-slate-800 dark:text-slate-400 font-mono">
            No BOQ Match
          </span>
        ),
    },
            ...
            <div className="flex items-center gap-2">
              ...
              <Badge
                ...
                className={cn("text-[10px] font-mono capitalize", {
                  ...
                  "bg-blue-50 text-blue-700 border-blue-300 dark:bg-blue-950/50 dark:text-blue-300": req.status === "partially_ordered",
