...
export const CHART_OF_ACCOUNTS = [
  ...
  { code: "1410", name: "Input VAT Receivable (from IRD)", category: "asset" },
  ...
  { code: "2003", name: "Material Deductions Recoverable (from Subcontractors)", category: "liability" },
  ...
  { code: "2040", name: "Staff Advances Recoverable", category: "asset" },
