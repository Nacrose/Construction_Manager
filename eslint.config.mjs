...
const eslintConfig = [
  ...
  ...nextTypescript,
  {
    rules: {
      ...
      // ── Central Engine Architectural Fences ─────────────────────────
      "no-restricted-syntax": [
        "warn",
        {
          selector: "JSXOpeningElement[name.name='table']",
          message: "Raw <table> elements are forbidden. Use <ConstructionTable /> from '@/components/ui/construction-table' instead.",
        },
        {
          selector: "CallExpression[callee.property.name='toLocaleString']",
          message: "Ad-hoc .toLocaleString() is forbidden. Use formatNpr() from '@/lib/currency' instead.",
        },
      ],
    },
  },
